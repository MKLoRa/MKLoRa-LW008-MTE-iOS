...
@interface MKMUPeriodicModeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKMUPeriodicModeModel *dataModel;

@end

@implementation MKMUPeriodicModeController

- (void)dealloc {
    NSLog(@"MKMUPeriodicModeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MTE", @"MKMUPeriodicModeController", @"mu_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMUPeriodicModeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMUPeriodicModeModel alloc] init];
    }
    return _dataModel;
}
