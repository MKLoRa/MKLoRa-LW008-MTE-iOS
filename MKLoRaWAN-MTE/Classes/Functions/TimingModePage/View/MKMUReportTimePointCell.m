...
@implementation MKMUReportTimePointCellModel
@end

@interface MKMUReportTimePointCell ()
...
@implementation MKMUReportTimePointCell

+ (MKMUReportTimePointCell *)initCellWithTableView:(UITableView *)tableView {
    MKMUReportTimePointCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMUReportTimePointCellIdenty"];
    if (!cell) {
        cell = [[MKMUReportTimePointCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMUReportTimePointCellIdenty"];
    }
    return cell;
}
...
- (void)deleteButtonPressed {
    if ([self.delegate respondsToSelector:@selector(mu_cellDeleteButtonPressed:)]) {
        [self.delegate mu_cellDeleteButtonPressed:self.dataModel.index];
    }
}
...
#pragma mark - setter
- (void)setDataModel:(MKMUReportTimePointCellModel *)dataModel {
    _dataModel = nil;
