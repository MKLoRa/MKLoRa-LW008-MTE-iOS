...
- (void)configData:(NSArray <MKMUTimingModeTimePointModel *>*)pointList
...
- (BOOL)configReportingTimePoint:(NSArray <MKMUTimingModeTimePointModel *>*)pointList {
    __block BOOL success = NO;
    [MKMUInterface mu_configTimingModeReportingTimePoint:pointList sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
