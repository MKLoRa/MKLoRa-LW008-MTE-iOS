...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        MKMUFilterByBeaconModel *model = [[MKMUFilterByBeaconModel alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 1) {
        ...
        MKMUFilterByUIDModel *model = [[MKMUFilterByUIDModel alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 2) {
        ...
        MKMUFilterByURLModel *model = [[MKMUFilterByURLModel alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 3) {
        ...
        MKMUFilterByTLMModel *model = [[MKMUFilterByTLMModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 0) {
        ...
        MKMUFilterByBXPButtonModel *model = [[MKMUFilterByBXPButtonModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 1) {
        ...
        MKMUFilterByBXPTagModel *model = [[MKMUFilterByBXPTagModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 2) {
        ...
        MKMUFilterByPirModel *model = [[MKMUFilterByPirModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 3) {
        ...
        MKMUFilterByTofModel *model = [[MKMUFilterByTofModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 4) {
        ...
        MKMUFilterByOtherModel *model = [[MKMUFilterByOtherModel alloc] init];
