//
//  MKMUFilterByBXPButtonController.m
...
@interface MKMUFilterByBXPButtonController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKMUFilterByBXPButtonModel *dataModel;

@property (nonatomic, strong)NSMutableArray *headerList;

@end

@implementation MKMUFilterByBXPButtonController

- (void)dealloc {
    NSLog(@"MKMUFilterByBXPButtonController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MTE", @"MKMUFilterByBXPButtonController", @"mu_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMUFilterByBXPButtonModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMUFilterByBXPButtonModel alloc] init];
    }
    return _dataModel;
}
