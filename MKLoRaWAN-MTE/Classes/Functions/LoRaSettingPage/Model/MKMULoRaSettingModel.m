...
@interface MKMULoRaSettingModel ()
...
@implementation MKMULoRaSettingModel
...
- (BOOL)readModem {
    ...
    [MKMUInterface mu_readLorawanModemWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configModem {
    __block BOOL success = NO;
    [MKMUInterface mu_configModem:(self.modem - 1) sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readRegion {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanRegionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configRegion {
    __block BOOL success = NO;
    [MKMUInterface mu_configRegion:self.region sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDevEUI {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanDEVEUIWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDevEUI {
    __block BOOL success = NO;
    [MKMUInterface mu_configDEVEUI:self.devEUI sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppEUI {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanAPPEUIWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppEUI {
    __block BOOL success = NO;
    [MKMUInterface mu_configAPPEUI:self.appEUI sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppKey {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanAPPKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppKey {
    __block BOOL success = NO;
    [MKMUInterface mu_configAPPKEY:self.appKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDevAddr {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanDEVADDRWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDevAddr {
    __block BOOL success = NO;
    [MKMUInterface mu_configDEVADDR:self.devAddr sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppSkey {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanAPPSKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppSkey {
    __block BOOL success = NO;
    [MKMUInterface mu_configAPPSKEY:self.appSKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNwkSkey {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanNWKSKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNwkSkey {
    __block BOOL success = NO;
    [MKMUInterface mu_configNWKSKEY:self.nwkSKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCHValue {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanCHWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCHValue {
    __block BOOL success = NO;
    [MKMUInterface mu_configCHL:self.CHL CHH:self.CHH sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDutyStatus {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanDutyCycleStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDutyStatus {
    __block BOOL success = NO;
    [MKMUInterface mu_configDutyCycleStatus:self.dutyIsOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readJoinValue {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanDRWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configJoinValue {
    __block BOOL success = NO;
    [MKMUInterface mu_configDR:self.join sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUplinkStrategy {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanUplinkStrategyWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUplinkStrategy {
    __block BOOL success = NO;
    [MKMUInterface mu_configUplinkStrategy:self.adrIsOn transmissions:1 DRL:self.DRL DRH:self.DRH sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readACKLimit {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanADRACKLimitWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configACKLimit {
    __block BOOL success = NO;
    [MKMUInterface mu_configLorawanADRACKLimit:[self.ackLimit integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readACKDelay {
    __block BOOL success = NO;
    [MKMUInterface mu_readLorawanADRACKDelayWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configACKDelay {
    __block BOOL success = NO;
    [MKMUInterface mu_configLorawanADRACKDelay:[self.ackDelay integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)restartDevice {
    __block BOOL success = NO;
    [MKMUInterface mu_restartDeviceWithSucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
