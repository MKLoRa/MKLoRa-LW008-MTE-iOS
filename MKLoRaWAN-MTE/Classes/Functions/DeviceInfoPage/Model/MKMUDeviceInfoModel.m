...
@implementation MKMUDeviceInfoModel
...
- (BOOL)readMacAddress {
    ...
    [MKMUInterface mu_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKMUInterface mu_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKMUInterface mu_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKMUInterface mu_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKMUInterface mu_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readVoltage {
    __block BOOL success = NO;
    [MKMUInterface mu_readBatteryVoltageWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKMUInterface mu_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
