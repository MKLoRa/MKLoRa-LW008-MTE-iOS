...
@implementation MKMUPCBAStatusCellModel
@end

@interface MKMUPCBAStatusCell ()
...
@implementation MKMUPCBAStatusCell

+ (MKMUPCBAStatusCell *)initCellWithTableView:(UITableView *)tableView {
    MKMUPCBAStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMUPCBAStatusCellIdenty"];
    if (!cell) {
        cell = [[MKMUPCBAStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMUPCBAStatusCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKMUPCBAStatusCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKMUPCBAStatusCellModel.class]) {
        return;
    }
