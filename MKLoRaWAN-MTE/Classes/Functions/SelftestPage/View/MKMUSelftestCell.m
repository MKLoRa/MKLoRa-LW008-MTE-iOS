...
@implementation MKMUSelftestCellModel
@end

@interface MKMUSelftestCell ()
...
@implementation MKMUSelftestCell

+ (MKMUSelftestCell *)initCellWithTableView:(UITableView *)tableView {
    MKMUSelftestCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMUSelftestCellIdenty"];
    if (!cell) {
        cell = [[MKMUSelftestCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMUSelftestCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKMUSelftestCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKMUSelftestCellModel.class]) {
        return;
    }
