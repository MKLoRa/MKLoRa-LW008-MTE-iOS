...
@implementation MKMUMsgIconButton
...
@interface MKMUSynTableHeaderView ()
...
@property (nonatomic, strong)MKMUMsgIconButton *synButton;

@property (nonatomic, strong)MKMUMsgIconButton *emptyButton;

@property (nonatomic, strong)MKMUMsgIconButton *exportButton;
...
@implementation MKMUSynTableHeaderView
...
- (MKMUMsgIconButton *)synButton {
    if (!_synButton) {
        _synButton = [[MKMUMsgIconButton alloc] init];
        _synButton.topIcon.image = LOADICON(@"MKLoRaWAN-MTE", @"MKMUSynTableHeaderView", @"mu_sync_enableIcon.png");
        _synButton.msgLabel.text = @"Sync";
    }
    return _synButton;
}

- (MKMUMsgIconButton *)emptyButton {
    if (!_emptyButton) {
        _emptyButton = [[MKMUMsgIconButton alloc] init];
        _emptyButton.topIcon.image = LOADICON(@"MKLoRaWAN-MTE", @"MKMUSynTableHeaderView", @"mu_delete_enableIcon.png");
        _emptyButton.msgLabel.text = @"Empty";
    }
    return _emptyButton;
}

- (MKMUMsgIconButton *)exportButton {
    if (!_exportButton) {
        _exportButton = [[MKMUMsgIconButton alloc] init];
        _exportButton.topIcon.image = LOADICON(@"MKLoRaWAN-MTE", @"MKMUSynTableHeaderView", @"mu_export_enableIcon.png");
