...
@implementation MKMUAboutController

- (void)dealloc {
    NSLog(@"MKMUAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-MTE", @"MKMUAboutController", @"mu_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-MTE", @"MKMUAboutController", @"mu_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
