...
@interface MKMUBleSettingsModel ()
...
@implementation MKMUBleSettingsModel
...
- (BOOL)readAdvName {
    ...
    [MKMUInterface mu_readDeviceNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvName {
    __block BOOL success = NO;
    [MKMUInterface mu_configDeviceName:self.advName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBroadcastTimeout {
    __block BOOL success = NO;
    [MKMUInterface mu_readBroadcastTimeoutWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBroadcastTimeout {
    __block BOOL success = NO;
    [MKMUInterface mu_configBroadcastTimeout:[self.timeout integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNeedPassword {
    __block BOOL success = NO;
    [MKMUInterface mu_readConnectationNeedPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNeedPassword {
    __block BOOL success = NO;
    [MKMUInterface mu_configNeedPassword:self.needPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readTxPower {
    __block BOOL success = NO;
    [MKMUInterface mu_readTxPowerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTxPower {
    __block BOOL success = NO;
    [MKMUInterface mu_configTxPower:self.txPower sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configBeaconMode {
    __block BOOL success = NO;
    [MKMUInterface mu_configBeaconStatus:self.beaconMode sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
