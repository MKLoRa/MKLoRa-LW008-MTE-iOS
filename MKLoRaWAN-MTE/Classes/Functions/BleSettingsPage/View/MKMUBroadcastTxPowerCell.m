...
@implementation MKMUBroadcastTxPowerCellModel
@end

@interface MKMUBroadcastTxPowerCell ()
...
@implementation MKMUBroadcastTxPowerCell

+ (MKMUBroadcastTxPowerCell *)initCellWithTableView:(UITableView *)tableView {
    MKMUBroadcastTxPowerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKMUBroadcastTxPowerCellIdenty"];
    if (!cell) {
        cell = [[MKMUBroadcastTxPowerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKMUBroadcastTxPowerCellIdenty"];
    }
    return cell;
}
...
- (void)txPowerSliderValueChanged {
    ...
    if ([self.delegate respondsToSelector:@selector(mu_txPowerValueChanged:)]) {
        [self.delegate mu_txPowerValueChanged:(NSInteger)self.slider.value];
    }
}
...
#pragma mark - setter
- (void)setDataModel:(MKMUBroadcastTxPowerCellModel *)dataModel {
    _dataModel = nil;
