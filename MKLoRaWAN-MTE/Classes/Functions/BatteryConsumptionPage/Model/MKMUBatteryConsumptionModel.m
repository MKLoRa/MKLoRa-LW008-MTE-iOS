...
@interface MKMUBatteryConsumptionModel ()
...
@implementation MKMUBatteryConsumptionModel
...
- (BOOL)readCurrent {
    ...
    [MKMUInterface mu_readBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readLast {
    __block BOOL success = NO;
    [MKMUInterface mu_readLastCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readAll {
    __block BOOL success = NO;
    [MKMUInterface mu_readAllCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
