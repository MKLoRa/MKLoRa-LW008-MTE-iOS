...
@interface MKMUMotionModeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKMUMotionModeModel *dataModel;

@end

@implementation MKMUMotionModeController

- (void)dealloc {
    NSLog(@"MKMUMotionModeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-MTE", @"MKMUMotionModeController", @"mu_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKMUMotionModeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMUMotionModeModel alloc] init];
    }
    return _dataModel;
}
