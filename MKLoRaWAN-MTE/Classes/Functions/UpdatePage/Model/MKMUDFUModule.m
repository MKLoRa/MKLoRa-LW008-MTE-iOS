...
@interface MKMUDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKMUDFUModule

- (void)dealloc{
    NSLog(@"MKMUDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKMUCentralManager shared].peripheral];
}
