...
@interface MKMUUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKMUDFUModule *dfuModule;
...
@implementation MKMUUpdateController

- (void)dealloc {
    NSLog(@"MKMUUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_mu_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKMUCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_mu_centralDeallocNotification" object:nil];
...
- (MKMUDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKMUDFUModule alloc] init];
    }
    return _dfuModule;
}
