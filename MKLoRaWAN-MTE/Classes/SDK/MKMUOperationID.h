...
#pragma mark - 模式相关参数读取
    ...
    mk_mu_taskReadMotionModeEventsOperation,                        //读取运动模式事件
...
#pragma mark - 蓝牙扫描过滤参数读取
    ...
    mk_mu_taskReadFilterByBXPTagIDStatusOperation,         //读取BXP-TagID类型开关
    mk_mu_taskReadPreciseMatchTagIDStatusOperation,        //读取BXP-TagID类型精准过滤tagID开关
    mk_mu_taskReadReverseFilterTagIDStatusOperation,    //读取读取BXP-TagID类型反向过滤tagID开关
    mk_mu_taskReadFilterBXPTagIDListOperation,             //读取BXP-TagID过滤规则
    ...
    mk_mu_taskReadBXPSensorInfoFilterByTagIDStatusOperation,    //读取BXP-SensorInfo设备过滤开关
    mk_mu_taskReadBXPSensorInfoPreciseMatchTagIDStatusOperation,    //读取BXP-SensorInfo类型精准过滤Tag-ID开关
    mk_mu_taskReadBXPSensorInfoReverseFilterTagIDStatusOperation,   //读取BXP-SensorInfo类型反向过滤Tag-ID开关
    mk_mu_taskReadBXPSensorInfoFilterBXPTagIDListOperation,         //读取BXP-SensorInfo类型设备Tag-ID过滤规则
...
#pragma mark - 配置模式相关参数
    ...
    mk_mu_taskConfigMotionModeEventsOperation,                      //配置运动模式事件
...
#pragma mark - 蓝牙扫描过滤参数配置
    ...
    mk_mu_taskConfigFilterByBXPTagIDStatusOperation,            //配置BXP-TagID类型过滤开关
    mk_mu_taskConfigPreciseMatchTagIDStatusOperation,           //配置BXP-TagID类型精准过滤Tag-ID开关
    mk_mu_taskConfigReverseFilterTagIDStatusOperation,          //配置BXP-TagID类型反向过滤Tag-ID开关
    mk_mu_taskConfigFilterBXPTagIDListOperation,                //配置BXP-TagID过滤规则
    ...
    mk_mu_taskConfigBXPSensorInfoFilterByTagIDStatusOperation,  //配置BXP-SensorInfo设备过滤开关
    mk_mu_taskConfigBXPSensorInfoPreciseMatchTagIDStatusOperation,  //配置BXP-SensorInfo类型精准过滤Tag-ID开关
    mk_mu_taskConfigBXPSensorInfoReverseFilterTagIDStatusOperation, //配置BXP-SensorInfo类型反向过滤Tag-ID开关
    mk_mu_taskConfigBXPSensorInfoFilterBXPTagIDListOperation,       //配置BXP-SensorInfo类型设备Tag-ID过滤规则
